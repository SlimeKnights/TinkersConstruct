...
import mods.tinker.tconstruct.client.block.PunjiRender;
...
import mods.tinker.tconstruct.client.entity.ArrowRender;
...
import mods.tinker.tconstruct.client.entity.DaggerRender;
import mods.tinker.tconstruct.client.entity.FancyItemRender;
import mods.tinker.tconstruct.client.entity.LaunchedItemRender;
...
import mods.tinker.tconstruct.client.gui.CraftingStationGui;
...
import mods.tinker.tconstruct.landmine.client.gui.GuiLandmine;
...
public class TProxyClient extends TProxyCommon
{
    ...
    public void initManualRecipes ()
    {
        ...
        TConstructClientRegistry.registerManualSmeltery("endstone", new ItemStack(Block.whiteStone), new ItemStack(TContent.liquidMetalStill, 1, 23), new ItemStack(Block.obsidian));
