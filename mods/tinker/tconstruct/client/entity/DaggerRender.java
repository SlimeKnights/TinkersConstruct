...
public class DaggerRender extends Render
{
    ...
    {
        renderer.renderItemIntoGUI(par1FontRenderer, par2RenderEngine, par3ItemStack, par4, par5);
    }
    ...
    {
        renderer.renderItemOverlayIntoGUI(par1FontRenderer, par2RenderEngine, par3ItemStack, par4, par5);
    }
