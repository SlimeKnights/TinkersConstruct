...
public abstract class Behavior {
	...
	public static void registerBuiltInBehaviors(){
		...
		for(int i = 1; i < Block.blocksList.length; i++){
			if(Block.blocksList[i] != null && Block.blocksList[i].isOpaqueCube() && Block.blocksList[i].renderAsNormalBlock() && !(Block.blocksList[i] instanceof ITileEntityProvider) && !behaviorsListBlocks.containsKey(new ItemStack(Block.blocksList[i]))){
