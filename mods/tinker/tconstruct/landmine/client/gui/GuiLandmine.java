package mods.tinker.tconstruct.landmine.client.gui;
...
public class GuiLandmine extends GuiContainer {
	...
	//ResourceLocation background = new ResourceLocation("tinker:textures/gui/landmine.png");Gui
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
        ...
        mc.renderEngine.bindTexture("/mods/tinker/textures/gui/landmine.png");
		int x = (width - xSize) / 2;
