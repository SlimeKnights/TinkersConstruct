package mods.tinker.tconstruct.landmine.block;
...
import mods.tinker.tconstruct.landmine.Helper;
import mods.tinker.tconstruct.landmine.client.render.RenderLandmine;
import mods.tinker.tconstruct.landmine.logic.LandmineExplodeLogic;
...
public class BlockLandmine extends BlockContainer {
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
		par5EntityPlayer.openGui(TConstruct.instance, TProxyCommon.landmineGui, par1World, par2, par3, par4);
		return true;
	}
			...
			for (int j1 = 0; j1 < tileentity.getSizeInventory(); ++j1) {
				...
				if (itemstack != null) {
					while (itemstack.stackSize > 0) {
						...
						EntityItem entityitem = new EntityItem(par1World, (double) ((float) par2), (double) ((float) par3), (double) ((float) par4), new ItemStack(itemstack.itemID, ss, itemstack.getItemDamage()));
	...
	protected int getMineState(World par1World, int par2, int par3, int par4) {
		...
		if (triggerMobType != null) {
			...
			if (triggerMobType == EnumMobType.mobs) {
				list = par1World.getEntitiesWithinAABB(EntityLiving.class, AxisAlignedBB.getAABBPool().getAABB(par2 + 0D, par3 + 0D, par4 + 0D, par2 + 1D, par3 + 1D, par4 + 1D));
			}
	...
	public Entity getMineTriggerer(World par1World, int par2, int par3, int par4) {
		...
		return new EntityTNTPrimed(par1World, par2, par3, par4, (EntityLiving) null);
	}
