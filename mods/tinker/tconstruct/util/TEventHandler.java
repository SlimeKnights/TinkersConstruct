...
public class TEventHandler
{
    ...
    public void registerOre (OreRegisterEvent evt)
    {
        ...
        else if (evt.Name == "ingotCopper")
        {
            ...
            Smeltery.addMelting(new ItemStack(evt.Ore.itemID, 2, evt.Ore.getItemDamage()), TContent.metalBlock.blockID, 3, 450, new FluidStack(TContent.liquidMetalStill.blockID,
                    TConstruct.ingotLiquidValue, 2));
        }

        else if (evt.Name == "ingotTin")
        {
            Smeltery.addMelting(new ItemStack(evt.Ore.itemID, 2, evt.Ore.getItemDamage()), TContent.metalBlock.blockID, 5, 175, new FluidStack(TContent.liquidMetalStill.blockID,
        ...
        else if (evt.Name == "ingotBronze")
        {
            ...
            Smeltery.addMelting(new ItemStack(evt.Ore.itemID, 2, evt.Ore.getItemDamage()), TContent.metalBlock.blockID, 4, 500, new FluidStack(TContent.liquidMetalStill.blockID,
        ...
        else if (evt.Name == "ingotCobalt")
        {
            ...
            Smeltery.addMelting(new ItemStack(evt.Ore.itemID, 2, evt.Ore.getItemDamage()), TContent.metalBlock.blockID, 0, 650, new FluidStack(TContent.liquidMetalStill.blockID,
        ...
        else if (evt.Name == "ingotArdite")
        {
            ...
            Smeltery.addMelting(new ItemStack(evt.Ore.itemID, 2, evt.Ore.getItemDamage()), TContent.metalBlock.blockID, 1, 650, new FluidStack(TContent.liquidMetalStill.blockID,
        ...
        else if (evt.Name == "ingotManyullyn")
        {
            ...
            Smeltery.addMelting(new ItemStack(evt.Ore.itemID, 2, evt.Ore.getItemDamage()), TContent.metalBlock.blockID, 2, 750, new FluidStack(TContent.liquidMetalStill.blockID,
                    TConstruct.ingotLiquidValue, 9));
        }

        else if (evt.Name == "ingotNaturalAluminum")
        {
            Smeltery.addMelting(new ItemStack(evt.Ore.itemID, 2, evt.Ore.getItemDamage()), TContent.metalBlock.blockID, 6, 250, new FluidStack(TContent.liquidMetalStill.blockID,
        ...
        {
            Smeltery.addMelting(new ItemStack(evt.Ore.itemID, 2, evt.Ore.getItemDamage()), TContent.metalBlock.blockID, 7, 350, new FluidStack(TContent.liquidMetalStill.blockID,
        ...
        else if (evt.Name == "ingotAlumite")
        {
            ...
            Smeltery.addMelting(new ItemStack(evt.Ore.itemID, 2, evt.Ore.getItemDamage()), TContent.metalBlock.blockID, 8, 500, new FluidStack(TContent.liquidMetalStill.blockID,
        ...
        else if (evt.Name == "ingotSteel")
        {
            ...
            Smeltery.addMelting(new ItemStack(evt.Ore.itemID, 2, evt.Ore.getItemDamage()), TContent.metalBlock.blockID, 9, 500, new FluidStack(TContent.liquidMetalStill.blockID,
        ...
        {
            Smeltery.addMelting(evt.Ore, 550, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 2, 2));
        }

        else if (evt.Name == "oreTin")
        {
            Smeltery.addMelting(evt.Ore, 275, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 2, 3));
        }

        else if (evt.Name == "oreNaturalAluminum")
        {
            Smeltery.addMelting(evt.Ore, 350, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 2, 4));
        }

        else if (evt.Name == "oreCobalt")
        {
            Smeltery.addMelting(evt.Ore, 750, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 2, 5));
        }

        else if (evt.Name == "oreArdite")
        {
            Smeltery.addMelting(evt.Ore, 750, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 2, 6));
        }

        //Blocks
        else if (evt.Name == "blockCopper")
        {
            Smeltery.addMelting(evt.Ore, 550, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 2));
        }

        else if (evt.Name == "blockTin")
        {
            Smeltery.addMelting(evt.Ore, 275, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 3));
        }

        else if (evt.Name == "blockBronze")
        {
            Smeltery.addMelting(evt.Ore, 500, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 7));
        }

        else if (evt.Name == "blockNaturalAluminum")
        {
            Smeltery.addMelting(evt.Ore, 350, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 4));
        }

        else if (evt.Name == "blockCobalt")
        {
            Smeltery.addMelting(evt.Ore, 750, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 5));
        }

        else if (evt.Name == "blockArdite")
        {
            Smeltery.addMelting(evt.Ore, 750, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 6));
        }

        else if (evt.Name == "blockManyullyn")
        {
            Smeltery.addMelting(evt.Ore, 800, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 9));
        }

        else if (evt.Name == "blockAluminumBrass")
        {
            Smeltery.addMelting(evt.Ore, 350, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 8));
        }

        else if (evt.Name == "blockAlumite")
        {
            Smeltery.addMelting(evt.Ore, 500, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 10));
        }

        else if (evt.Name == "blockSteel")
        {
            Smeltery.addMelting(evt.Ore, 500, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 12));
        }
    ...
    public void unfuxOreDictionary () //TODO: This isn't the best
    {
        ...
        for (ItemStack ore : ores)
        {
            ...
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 3, 450, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue,
                    2));
        }
        ...
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 5, 175, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue,
                    3));
        }
        ...
        for (ItemStack ore : ores)
        {
            ...
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 4, 500, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue,
                    7));
        }
        ...
        for (ItemStack ore : ores)
        {
            ...
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 0, 650, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue,
                    5));
        }
        ...
        for (ItemStack ore : ores)
        {
            ...
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 1, 650, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue,
                    6));
        }
        ...
        for (ItemStack ore : ores)
        {
            ...
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 2, 750, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue,
                    9));
        }
        ...
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 6, 250, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue,
                    4));
        }
        ...
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 7, 350, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue,
                    8));
        }
        ...
        for (ItemStack ore : ores)
        {
            ...
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 8, 500, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue,
                    10));
        }
        ...
        for (ItemStack ore : ores)
        {
            ...
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 9, 500, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue,
                    12));
        }
        ...
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 550, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 2, 2));
        }

        ores = OreDictionary.getOres("oreTin");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 275, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 2, 3));
        }

        ores = OreDictionary.getOres("oreNaturalAluminum");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 350, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 2, 4));
        }

        ores = OreDictionary.getOres("oreCobalt");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 750, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 2, 5));
        }

        ores = OreDictionary.getOres("oreArdite");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 750, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 2, 6));
        }

        ores = OreDictionary.getOres("blockCopper");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 550, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 2));
        }

        ores = OreDictionary.getOres("blockTin");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 275, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 3));
        }

        ores = OreDictionary.getOres("blockBronze");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 500, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 7));
        }

        ores = OreDictionary.getOres("blockNaturalAluminum");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 350, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 4));
        }

        ores = OreDictionary.getOres("blockCobalt");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 750, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 5));
        }

        ores = OreDictionary.getOres("blockArdite");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 750, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 6));
        }

        ores = OreDictionary.getOres("blockManyullyn");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 800, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 9));
        }

        ores = OreDictionary.getOres("blockAluminumBrass");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 350, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 8));
        }

        ores = OreDictionary.getOres("blockAlumite");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 500, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 10));
        }

        ores = OreDictionary.getOres("blockSteel");
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(ore, 500, new FluidStack(TContent.liquidMetalStill.blockID, TConstruct.ingotLiquidValue * 9, 12));
        }
        ...
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 3, 450, new FluidStack(TContent.liquidMetalStill.blockID,
        ...
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 5, 175, new FluidStack(TContent.liquidMetalStill.blockID,
        ...
        for (ItemStack ore : ores)
        {
            Smeltery.addMelting(new ItemStack(ore.itemID, 2, ore.getItemDamage()), TContent.metalBlock.blockID, 6, 250, new FluidStack(TContent.liquidMetalStill.blockID,
