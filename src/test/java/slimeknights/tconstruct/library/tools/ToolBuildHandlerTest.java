...
class ToolBuildHandlerTest extends BaseMcTest {
  ...
  void testBuildTool_correctItems() {
    ...
    ItemStack itemStack = ToolBuildHandler.buildItemFromStacks(input, 2, testToolCore);
  ...
  void tooManyItems_fail() {
    ...
    ItemStack itemStack = ToolBuildHandler.buildItemFromStacks(input, 3, testToolCore);
