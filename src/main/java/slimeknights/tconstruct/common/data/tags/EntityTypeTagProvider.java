...
public class EntityTypeTagProvider extends EntityTypeTagsProvider {
  ...
  public void registerTags() {
    ...
    this.getOrCreateBuilder(TinkerTags.EntityTypes.RARE_MOBS).add(EntityType.WITHER, EntityType.ENDER_DRAGON, EntityType.ELDER_GUARDIAN, EntityType.EVOKER, EntityType.PLAYER);
  }
