...
public class EntityTypeTagProvider extends EntityTypeTagsProvider {
  ...
  protected void addTags(Provider provider) {
    ...
    this.tag(TinkerTags.EntityTypes.MELTING_BEES).add(EntityType.BEE);
    this.tag(TinkerTags.EntityTypes.MELTING_BLAZES).add(EntityType.BLAZE);
    this.tag(TinkerTags.EntityTypes.MELTING_CREEPERS).add(EntityType.CREEPER);
    this.tag(TinkerTags.EntityTypes.MELTING_DROWNED).add(EntityType.DROWNED);
    this.tag(TinkerTags.EntityTypes.MELTING_ENDERMEN).add(EntityType.ENDERMAN);
    this.tag(TinkerTags.EntityTypes.MELTING_FROGS).add(EntityType.FROG);
    this.tag(TinkerTags.EntityTypes.MELTING_GHASTS).add(EntityType.GHAST);
    this.tag(TinkerTags.EntityTypes.MELTING_GUARDIANS).add(EntityType.GUARDIAN, EntityType.ELDER_GUARDIAN);
    this.tag(TinkerTags.EntityTypes.MELTING_MAGMA_CUBES).add(EntityType.MAGMA_CUBE);
    this.tag(TinkerTags.EntityTypes.MELTING_PHANTOMS).add(EntityType.PHANTOM);
    this.tag(TinkerTags.EntityTypes.MELTING_PIGLINS).add(EntityType.PIGLIN, EntityType.PIGLIN_BRUTE, EntityType.ZOMBIFIED_PIGLIN);
    this.tag(TinkerTags.EntityTypes.MELTING_SHULKERS).add(EntityType.SHULKER);
    this.tag(TinkerTags.EntityTypes.MELTING_SILVERFISH).add(EntityType.SILVERFISH);
    this.tag(TinkerTags.EntityTypes.MELTING_EARTH_SLIMES).add(EntityType.SLIME);
    this.tag(TinkerTags.EntityTypes.MELTING_SPIDERS).add(EntityType.SPIDER, EntityType.CAVE_SPIDER);
    this.tag(TinkerTags.EntityTypes.MELTING_STRIDERS).add(EntityType.STRIDER);
    this.tag(TinkerTags.EntityTypes.MELTING_TURTLES).add(EntityType.TURTLE);
    this.tag(TinkerTags.EntityTypes.MELTING_ZOMBIES).add(EntityType.ZOMBIE, EntityType.HUSK, EntityType.ZOMBIE_HORSE);
