...
public class BlockTagProvider extends BlockTagsProvider {
  ...
  private void addHarvest() {
    ...
    tagBlocks(MINEABLE_WITH_PICKAXE, NEEDS_GOLD_TOOL, TinkerSmeltery.searedLantern,   TinkerSmeltery.searedFaucet,   TinkerSmeltery.searedChannel,   TinkerSmeltery.searedBasin,   TinkerSmeltery.searedTable,   TinkerSmeltery.castingTank);
    ...
    tagBlocks(MINEABLE_MELTING_BLACKLIST, TinkerSmeltery.castingTank);
