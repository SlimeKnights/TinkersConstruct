...
public abstract class TinkerModule {
  ...
  protected static final DeferredRegister<IModifier> MODIFIERS = DeferredRegister.create(IModifier.class, TConstruct.modID);
  ...
  public static void initRegisters() {
    ...
    MODIFIERS.makeRegistry("modifier", RegistryBuilder::new);
