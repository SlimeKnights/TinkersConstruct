...
public final class TinkerFluids extends TinkerModule {
  ...
  public static final FluidObject<ForgeFlowingFluid> moltenQuartz   = FLUIDS.register("molten_quartz",   moltenBuilder().color(0xffddd4c6).temperature( 937), Material.LAVA,  2);
  public static final FluidObject<ForgeFlowingFluid> moltenDiamond  = FLUIDS.register("molten_diamond",  moltenBuilder().color(0xff4aedd9).temperature(1750), Material.LAVA,  5);
  ...
  public static final FluidObject<ForgeFlowingFluid> moltenSteel      = FLUIDS.register("molten_steel",      moltenBuilder().color(0xffa7a7a7).temperature(1250), Material.LAVA, 12);
