...
final class Materials {
  ...
  private static final Supplier<List<ModifierEntry>> SLIMEWOOD_TRAITS = () -> Arrays.asList(new ModifierEntry(TinkerModifiers.overgrowth.get(), 1), new ModifierEntry(TinkerModifiers.overslime.get(), 1));
  public static final IMaterial slimewood   = mat(new DataMaterial(MaterialIds.slimewood, 2, ORDER_SPECIAL, false, 0x82c873, SLIMEWOOD_TRAITS));
  // tier 3
