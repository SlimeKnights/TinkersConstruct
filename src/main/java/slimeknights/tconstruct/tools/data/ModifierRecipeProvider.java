...
public class ModifierRecipeProvider extends BaseRecipeProvider {
  ...
  private void addItemRecipes(Consumer<IFinishedRecipe> consumer) {
    ...
    ItemCastingRecipeBuilder.tableRecipe(TinkerModifiers.searedReinforcement)
                            .setFluid(FluidIngredient.of(FluidIngredient.of(TinkerFluids.searedStone.getLocalTag(), FluidValues.INGOT), FluidIngredient.of(TinkerFluids.scorchedStone.getLocalTag(), FluidValues.INGOT)))
                            .setCoolingTime(TinkerFluids.searedStone.get().getAttributes().getTemperature() - 300, FluidValues.INGOT)
                            .setCast(TinkerCommons.obsidianPane, true)
  ...
  private void luckRecipes(Consumer<IFinishedRecipe> consumer, Modifier modifier, ITag<Item> tools, SlotType slotType, boolean unarmed, String folder, String salvage) {
    ...
    builder1.buildSalvage(consumer, wrap(modifier, salvage, "_level_1")).build(consumer, wrap(modifier, folder, "_level_1"));
    ...
    builder2.buildSalvage(consumer, wrap(modifier, salvage, "_level_2")).build(consumer, wrap(modifier, folder, "_level_2"));
    builder3.buildSalvage(consumer, wrap(modifier, salvage, "_level_3")).build(consumer, wrap(modifier, folder, "_level_3"));
  }
