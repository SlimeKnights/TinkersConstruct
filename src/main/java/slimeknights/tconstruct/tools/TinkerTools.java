...
public final class TinkerTools extends TinkerModule {
  ...
  public static final EnumObject<ArmorSlotType,ModifiableArmorItem> slimesuit = ITEMS.registerEnum("slime", new ArmorSlotType[]{ArmorSlotType.BOOTS, ArmorSlotType.HELMET}, type -> new ModifiableArmorItem(ArmorDefinitions.SLIMESUIT, type, TOOL.get()));
