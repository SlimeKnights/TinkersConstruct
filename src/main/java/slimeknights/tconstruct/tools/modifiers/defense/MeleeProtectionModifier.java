...
/** @deprecated use {@link ProtectionModule}, {@link TinkerDataKeys#USE_ITEM_SPEED}, and {@link MaxArmorStatModule} */
@Deprecated(forRemoval = true)
public class MeleeProtectionModifier extends Modifier {
  @Override
  protected void registerHooks(Builder hookBuilder) {
    super.registerHooks(hookBuilder);
    hookBuilder.addModule(MaxArmorStatModule.builder(TinkerDataKeys.USE_ITEM_SPEED).heldTag(TinkerTags.Items.HELD).tooltipStyle(TooltipStyle.PERCENT).eachLevel(0.05f));
