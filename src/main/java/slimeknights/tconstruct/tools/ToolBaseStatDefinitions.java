...
public final class ToolBaseStatDefinitions {
  ...
  static final ToolBaseStatDefinition SLEDGE_HAMMER = new ToolBaseStatDefinition.Builder()
    .setDamageBonus(1f).setDamageModifier(1.5f).setAttackSpeed(0.8f).setMiningSpeedModifier(0.4f).setDurabilityModifier(4f).setPrimaryHeadWeight(2).build();
  ...
  static final ToolBaseStatDefinition EXCAVATOR = new ToolBaseStatDefinition.Builder()
    .setDamageBonus(1.5f).setDamageModifier(1.25f).setAttackSpeed(0.7f).setMiningSpeedModifier(0.3f).setDurabilityModifier(3.75f).setKnockbackBonus(1f).build();
