...
public final class ToolBaseStatDefinitions {
  ...
  static final ToolBaseStatDefinition HAMMER = new ToolBaseStatDefinition.Builder()
    .setDamageModifier(1.2f).setAttackSpeed(0.8f).setMiningSpeedModifier(0.4f).setDurabilityModifier(2.5f).build();
  ...
  static final ToolBaseStatDefinition EXCAVATOR = new ToolBaseStatDefinition.Builder()
    .setDamageModifier(1.25f).setAttackSpeed(0.7f).setMiningSpeedModifier(0.28f).setDurabilityModifier(1.75f).build();

  // axes
  static final ToolBaseStatDefinition AXE = new ToolBaseStatDefinition.Builder()
    .setDamageBonus(0.5f).setDamageModifier(1.1f).setAttackSpeed(1.1f).setKnockbackModifier(1.3f).build();
  ...
  static final ToolBaseStatDefinition BROADSWORD = new ToolBaseStatDefinition.Builder()
    .setDamageBonus(1).setDamageModifier(1).setAttackSpeed(1.6f).setMiningSpeedModifier(0.5f).setDurabilityModifier(1.1f).build();
}
