...
public final class TinkerToolParts extends TinkerModule {
  ...
  public static final ItemObject<ToolPart> hammerHead = ITEMS.register("hammer_head", () -> new ToolPart(PARTS_PROPS, HeadMaterialStats.ID));
  ...
  public static final ItemObject<ToolPart> largePlate = ITEMS.register("large_plate", () -> new ToolPart(PARTS_PROPS, HeadMaterialStats.ID));
  public static final ItemObject<ToolPart> toolRod = ITEMS.register("tool_rod", () -> new ToolPart(PARTS_PROPS, HandleMaterialStats.ID));
  public static final ItemObject<ToolPart> toughToolRod = ITEMS.register("tough_tool_rod", () -> new ToolPart(PARTS_PROPS, HandleMaterialStats.ID));
}
