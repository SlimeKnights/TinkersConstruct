...
public class AxeAttackParticle extends AttackParticle {
  ...
  public AxeAttackParticle(ClientLevel world, double x, double y, double z, double quadSize, SpriteSet spriteList) {
  ...
  public static class Factory implements ParticleProvider<SimpleParticleType> {
    ...
    public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
      return new AxeAttackParticle(worldIn, x, y, z, xSpeed, this.spriteSet);
    }
  }
}
