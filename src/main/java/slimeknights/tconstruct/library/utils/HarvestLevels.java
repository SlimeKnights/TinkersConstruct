...
public class HarvestLevels {
  ...
  public static void init() {
    harvestLevelNames.put(STONE, TinkerMaterials.stone.textColor + Util.translate("ui.mininglevel.stone"));
    harvestLevelNames.put(IRON, TinkerMaterials.iron.textColor + Util.translate("ui.mininglevel.iron"));
    harvestLevelNames.put(DIAMOND, EnumChatFormatting.AQUA + Util.translate("ui.mininglevel.diamond"));
    harvestLevelNames.put(OBSIDIAN, TinkerMaterials.obsidian.textColor + Util.translate("ui.mininglevel.obsidian"));
    harvestLevelNames.put(COBALT, TinkerMaterials.cobalt.textColor + Util.translate("ui.mininglevel.cobalt"));
  }
