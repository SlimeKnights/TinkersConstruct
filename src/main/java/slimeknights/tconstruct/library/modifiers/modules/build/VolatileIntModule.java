 ...
 */
public record VolatileIntModule(ResourceLocation flag, LevelingInt value, ModifierCondition<IToolContext> condition) implements VolatileDataModifierHook, ModifierModule, ConditionalModule<IToolContext> {
  ...
  public VolatileIntModule(ResourceLocation flag, LevelingInt value) {
