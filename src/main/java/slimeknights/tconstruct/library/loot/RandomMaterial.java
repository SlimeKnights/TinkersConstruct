...
public class RandomMaterial extends LootFunction {
  ...
  protected RandomMaterial(LootCondition[] conditionsIn, @Nullable List<Material> materialsIn) {
    super(conditionsIn);
  ...
  public static class Serializer extends LootFunction.Serializer<RandomMaterial> {
    ...
    @Override
    public void serialize(JsonObject object, RandomMaterial functionClazz, JsonSerializationContext serializationContext) {
    ...
    @Nonnull
    @Override
    public RandomMaterial deserialize(@Nonnull JsonObject object, @Nonnull JsonDeserializationContext deserializationContext, @Nonnull LootCondition[] conditionsIn) {
      List<Material> list = Lists.<Material>newArrayList();
      ...
      return new RandomMaterial(conditionsIn, list);
    }
  }
}
