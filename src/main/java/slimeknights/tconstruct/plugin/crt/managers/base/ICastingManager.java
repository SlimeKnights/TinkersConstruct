...
public interface ICastingManager extends IRecipeManager {
  ...
  @ZenCodeType.Method
  default void addItemCastingRecipe(String name, IIngredient cast, IFluidStack fluid, IItemStack result, int coolingTime, boolean consumeCast, boolean switchSlots) {
    ...
    ItemCastingRecipe recipe = makeItemCastingRecipe(id, castIngredient, fluidIngredient, itemOutput, coolingTime, consumeCast, switchSlots);
