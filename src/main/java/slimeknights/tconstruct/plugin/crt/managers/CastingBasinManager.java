...
public class CastingBasinManager implements IRecipeManager {
  ...
  public void addItemCastingRecipe(String name, IIngredient cast, IFluidStack fluid, IItemStack result, int coolingTime, boolean consumed, boolean switchSlots) {
    ...
    ItemCastingRecipe.Basin basin = new ItemCastingRecipe.Basin(id, "", castIngredient, fluidIngredient, itemOutput, coolingTime, consumed, switchSlots);
  ...
  public void addMaterialCastingRecipe(String name, IIngredient cast, int fluidAmount, Item result, boolean consumed, boolean switchSlots) {
    ...
    ResourceLocation id = new ResourceLocation("crafttweaker", name);
    Ingredient castIngredient = cast.asVanillaIngredient();
    MaterialCastingRecipe.Basin recipe = new MaterialCastingRecipe.Basin(id, "", castIngredient, fluidAmount, (IMaterialItem) result, consumed, switchSlots);
