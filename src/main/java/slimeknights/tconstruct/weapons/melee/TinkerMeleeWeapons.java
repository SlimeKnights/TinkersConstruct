package slimeknights.tconstruct.weapons.melee;
...
import slimeknights.tconstruct.weapons.melee.item.BattleSign;
import slimeknights.tconstruct.weapons.melee.item.BroadSword;
import slimeknights.tconstruct.weapons.melee.item.Cleaver;
import slimeknights.tconstruct.weapons.melee.item.FryPan;
import slimeknights.tconstruct.weapons.melee.item.LongSword;
import slimeknights.tconstruct.weapons.melee.item.Rapier;
...
public class TinkerMeleeWeapons extends AbstractToolPulse {
  ...
  @SidedProxy(clientSide = "slimeknights.tconstruct.weapons.melee.MeleeClientProxy", serverSide = "slimeknights.tconstruct.common.CommonProxy")
