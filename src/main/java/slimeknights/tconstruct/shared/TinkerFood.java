...
public final class TinkerFood {
  ...
  public static final Food GOLD_SLIME_BALL = (new Food.Builder()).hunger(2).saturation(14.4f).setAlwaysEdible().effect(() -> new EffectInstance(Effects.LUCK, 20 * 10, 2), 1.0F).build();
