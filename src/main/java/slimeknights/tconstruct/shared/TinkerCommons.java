...
public final class TinkerCommons extends TinkerModule {
  ...
  public static final BuildingBlockObject driedClay = BLOCKS.registerBuilding("dried_clay", DRIED_CLAY, (Function<Block, BlockItem>) HIDDEN_BLOCK_ITEM);
  public static final BuildingBlockObject driedClayBricks = BLOCKS.registerBuilding("dried_clay_bricks", DRIED_CLAY, (Function<Block, BlockItem>) HIDDEN_BLOCK_ITEM);
  // glass
  ...
  // wood
  private static final AbstractBlock.Settings WOOD = builder(Material.WOOD, ToolType.AXE, BlockSoundGroup.WOOD).requiresTool().strength(2.0F, 7.0F).luminance(s -> 7);
  ...
  void gatherData(final GatherDataEvent event) {
    if (event.includeServer()) {
      ...
      datagenerator.install(new CommonRecipeProvider(datagenerator));
    }
  }
}
