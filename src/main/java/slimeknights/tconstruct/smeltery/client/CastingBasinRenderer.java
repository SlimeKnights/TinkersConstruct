...
public class CastingBasinRenderer extends TileEntitySpecialRenderer<TileCastingBasin> {

  @Override
  public void renderTileEntityAt(TileCastingBasin te, double x, double y, double z, float partialTicks, int destroyStage) {
