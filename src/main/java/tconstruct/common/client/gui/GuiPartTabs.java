...
public class GuiPartTabs extends GuiPart {
  ...
  public GuiPartTabs(GuiMultiModule parent, GuiElement tabLeft, GuiElement tabCenter, GuiElement tabRight, GuiElement activeLeft, GuiElement activeCenter, GuiElement activeRight) {
    this.parent = parent;
