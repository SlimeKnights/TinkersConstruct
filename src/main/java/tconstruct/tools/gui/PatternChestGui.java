...
public class PatternChestGui extends GuiContainer {
    ...
    public PatternChestGui(
            InventoryPlayer inventoryplayer, PatternChestLogic holder, World world, int x, int y, int z) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        fontRendererObj.drawString(
                StatCollector.translateToLocal("container.inventory"), 17, (ySize - 96) + 2, 0x404040);
    }
