...
public abstract class AbstractTab extends GuiButton
{
    ...
    public void drawButton (Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            this.itemRenderer.renderItemAndEffectIntoGUI(mc.fontRendererObj, mc.renderEngine, renderStack, xPosition + 6, yPosition + 8);
            this.itemRenderer.renderItemOverlayIntoGUI(mc.fontRendererObj, mc.renderEngine, renderStack, xPosition + 6, yPosition + 8);
