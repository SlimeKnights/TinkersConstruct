...
public class TProxyClient extends TProxyCommon
{
    ...
    public void initManualRecipes ()
    {
        ...
        TConstructClientRegistry.registerManualLargeRecipe("featherfall", wings.copy(), new ItemStack(TContent.slimeGel, 1, 0), feather, feather, feather, wings.copy(), feather, feather, new ItemStack(
