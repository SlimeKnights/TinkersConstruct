...
public class StencilTableGui extends GuiContainer
{
    ...
    public void initGui ()
    {
        ...
        this.buttonList.add(new GuiButtonItem(0, cornerX - 110, cornerY, new ItemStack(TRepo.toolRod, 1, 0)));
        this.buttonList.add(new GuiButtonItem(1, cornerX - 88, cornerY, new ItemStack(TRepo.pickaxeHead, 1, 0)));
        this.buttonList.add(new GuiButtonItem(2, cornerX - 66, cornerY, new ItemStack(TRepo.binding, 1, 0)));
        this.buttonList.add(new GuiButtonItem(3, cornerX - 44, cornerY, new ItemStack(TRepo.shovelHead, 1, 0)));
        this.buttonList.add(new GuiButtonItem(4, cornerX - 22, cornerY, new ItemStack(TRepo.hatchetHead, 1, 0)));
