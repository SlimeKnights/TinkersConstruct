...
public class ArrowShaftMaterial extends CustomMaterial {
    ...
    public static ArrowShaftMaterial createMaterial(
            int id, Item input, float durabilityModifier, float weight, float fragility, int color) {
        return createMaterial(id, input, 0, durabilityModifier, weight, fragility, color);
    }

    public static ArrowShaftMaterial createMaterial(
            int id, Item input, int inputMeta, float durabilityModifier, float weight, float fragility, int color) {
