...
public class TConstructRegistry
{
    ...
    static void initializeDrawbridgeState ()
    {
        ...
        drawbridgeState[Blocks.waterMoving] = 1;
        ...
        drawbridgeState[Blocks.oreGold] = 1;
        drawbridgeState[Blocks.oreIron] = 1;
        drawbridgeState[Blocks.oreCoal] = 1;
        drawbridgeState[Blocks.sponge] = 1;
        drawbridgeState[Blocks.oreLapis] = 1;
        drawbridgeState[Blocks.blockLapis] = 1;
        ...
        drawbridgeState[Blocks.pistonStickyBase] = 3;
        drawbridgeState[Blocks.web] = 1;
        drawbridgeState[Blocks.pistonBase] = 3;
        drawbridgeState[Blocks.pistonExtension] = 2;
