...
public class CastingRecipe
{
    ...
    {
        if (castingMetal.isFluidEqual(metal) && ((cast != null && cast.getMetadata() == Short.MAX_VALUE && inputCast.getItem() == cast.getItem()) || ItemStack.areItemStacksEqual(this.cast, inputCast)))
        {
            return true;
        }
        else
