...
public class PHConstruct
{
    ...
    public static void initProps (File location)
    {
        ...
        ingotsBrassAlloy = config.get("Smeltery Output Modification", "Brass ingot return", 4, "Number of ingots returned from smelting Brass in the smeltery").getDouble(4);
        ingotsZarconAlloy = config.get("Smeltery Output Modification", "Zarcon ingot return", 3, "Number of ingots returned from smelting Zarcon in the smeltery").getDouble(3);
        ...
        generateZinc = config.get("Worldgen Disabler", "Generate Zinc", xycraft).getBoolean(xycraft);
        ...
        generateZincSurface = config.get("Worldgen Disabler", "Generate Surface Zinc", true).getBoolean(true);
        ...
        generateZincBush = config.get("Worldgen Disabler", "Generate Zinc Bushes", true).getBoolean(true);
        ...
        zincuDensity = config.get("Worldgen", "Zinc Underground Density", 3).getInt(3);
        ...
        zincuMinY = config.get("Worldgen", "Zinc Underground Min Y", 0).getInt(0);
        zincuMaxY = config.get("Worldgen", "Zinc Underground Max Y", 64).getInt(64);
        ...
        zincsRarity = config.get("Worldgen", "Zinc Surface Rarity", 50).getInt(50);
        ...
        zincBushDensity = config.get("Worldgen", "Zinc Bush Density", 2).getInt(2);
        ...
        zincBushRarity = config.get("Worldgen", "Zinc Bush Rarity", 2).getInt(2);
        ...
        zincBushMinY = config.get("Worldgen", "Zinc Bush Min Y", 0).getInt(0);
        zincBushMaxY = config.get("Worldgen", "Zinc Bush Max Y", 60).getInt(60);
    ...
    public static boolean generateZincSurface;
    ...
    public static boolean generateZincBush;
    ...
    public static int zincuDensity;
    ...
    public static int zincBushDensity;
    ...
    public static int zincBushRarity;
    ...
    public static int zincuMinY;
    public static int zincuMaxY;
    ...
    public static int zincBushMinY;
    public static int zincBushMaxY;
    ...
    public static double ingotsBrassAlloy;
    public static double ingotsZarconAlloy;
