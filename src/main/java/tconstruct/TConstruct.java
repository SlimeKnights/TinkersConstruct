...
@Mod(modid = "TConstruct", name = "TConstruct", version = "${version}",
        dependencies = "required-after:Forge@[10.13.1.1217,);required-after:Mantle@[1.7.10-0.3.2,);after:MineFactoryReloaded@[1.7.10R2.8.0,);after:NotEnoughItems;after:Waila;after:ThermalExpansion@[1.7.10R4.0.0RC2,);after:ThermalFoundation@[1.7.10R1.0.0RC3,);before:UndergroundBiomes")
