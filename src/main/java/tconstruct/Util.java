...
public class Util {
  ...
  /**
   * Returns the given Resource prefixed with tinkers resource location.
   * Use this function instead of hardcoding resource locations.
   */
  ...
  /**
   * Prefixes the given unlocalized name with tinkers prefix.
   * Use this when passing unlocalized names for a uniform namespace.
   */
