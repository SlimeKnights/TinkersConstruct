...
public class Mattock extends DualHarvestTool
{
    ...
    static Material[] axeMaterials = { Material.wood, Material.cactus, Material.pumpkin, Material.plants, Material.vine, Material.sponge, Material.coral, Material.cake };
