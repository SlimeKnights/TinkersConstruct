...
import tconstruct.world.entity.Guardian;

public class GuardianRenderer extends RenderLiving {
    private static final ResourceLocation[] texture = new ResourceLocation[] {
            new ResourceLocation("tinker", "textures/mob/guardianamber.png"),
            new ResourceLocation("tinker", "textures/mob/guardianmorganite.png"),
            new ResourceLocation("tinker", "textures/mob/guardianturquoise.png")
    };

    private static GuardianModel model = new GuardianModel();

    public GuardianRenderer()
    {
        super(model, 0.5F);
    }
    ...
    {
        return texture[((Guardian)par1Entity).type];
    }
}
