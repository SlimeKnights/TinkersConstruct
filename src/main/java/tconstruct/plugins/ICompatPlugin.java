 ...
 * 
 * Do not include mod API usage directly in this file except for IMC! This must
 * be constructable even when the target mod isn't available due to Java not
 * allowing static abstracts.
 */
