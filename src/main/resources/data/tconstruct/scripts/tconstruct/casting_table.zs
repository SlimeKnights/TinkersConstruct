...
// <recipetype:tconstruct:casting_table>.addItemCastingRecipe(name as string, cast as IIngredient, fluid as IFluidStack, result as IItemStack, coolingTime as int, consumed as boolean, switchSlots as boolean)
// <recipetype:tconstruct:casting_table>.addMaterialCastingRecipe(name as string, cast as IIngredient, fluidAmount as int, result as Item, consumed as boolean, switchSlots as boolean)
