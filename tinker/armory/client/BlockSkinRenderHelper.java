...
{
	public static boolean renderStandardMetadataBlock (Block block, int metadata, int x, int y, int z, RenderBlocks render, IBlockAccess world)
	{
		...
		return Minecraft.isAmbientOcclusionEnabled() && Block.lightValue[block.blockID] == 0 ? 
				renderMetadataBlockWithAmbientOcclusion(block, metadata, x, y, z, var6, var7, var8, render, world)
				: renderMetadataBlockWithColorMultiplier(block, metadata, x, y, z, var6, var7, var8, render, world);
	}
